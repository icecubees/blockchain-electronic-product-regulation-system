...
db.product.hasMany(db.afterSalesRequest, { as: "afterSalesRequests", foreignKey: "productId" });
...
db.order.hasMany(db.afterSalesRequest, { as: "afterSalesRequests", foreignKey: "orderId" });
...
db.afterSalesRequest.belongsTo(db.order, { as: "order", foreignKey: "orderId" });
db.afterSalesRequest.belongsTo(db.product, { as: "product", foreignKey: "productId" });
db.afterSalesRequest.belongsTo(db.user, { as: "buyer", foreignKey: "buyerId" });
...
db.user.hasMany(db.afterSalesRequest, { as: "afterSalesRequests", foreignKey: "buyerId" });
